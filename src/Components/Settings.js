            ...
            <div id="todo">
                <div id="containerlog" className="perfil" >
                    ...
                    <div id="settingsDiv" className="background_Formularis">
                        ...
                        {!this.state.stat ? null : <div className="Container"><p id="canviarCont" onClick={() => this.changeStat(false)}>Canviar contrasenya</p></div>}
                        {this.state.stat ? <fieldset className="monstresDataGrid">
